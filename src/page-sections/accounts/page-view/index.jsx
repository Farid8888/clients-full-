...
// API KEYS CONTEXT FILE
import { ApiKeysProvider } from "contexts/ApiKeysContext";
import { useTranslation } from "react-i18next";
import { TFAProvider } from "contexts/TFAContext";
  ...
  return <Box pt={2} pb={4}>
      <Grid container spacing={3}>
        ...
        <Grid item md={9} xs={12}>
          {active === tabList[0].name && <ApiKeysProvider><TabComponent.ExgobitApiKeys /></ApiKeysProvider>}
          {active === tabList[1].name && <TabComponent.Password />}
          {active === tabList[2].name && <TFAProvider><TabComponent.TwoStepVerification /></TFAProvider>}
