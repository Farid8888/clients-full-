...
const TradersPageView = () => {
  ...
  useEffect(() => {
    ...
    setUsers(tradersList);
    return () => clearInterval(intervalId)
  }, [tradersList, firstFetch, updateTradersList]);
        ...
        <TableContainer>
          <Scrollbar autoHide={false}>
            <Table>
              ...
              <TableBody>
                {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(user => <UserTableRow key={user.id} user={user} isSelected={isSelected(user.id)} handleSelectRow={handleSelectRow} handleEditTrader={handleEditTrader} />)}
